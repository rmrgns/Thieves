...
#pragma region EscapeZone
	{
		...
		for (auto& gameObject : gameObjects)
		{
			gameObject->SetName(L"EscapeZone1");
			gameObject->SetCheckFrustum(false);
			gameObject->GetTransform()->SetLocalPosition(Vec3(0.f, -4000.f, 0.f));
			//gameObject->GetTransform()->SetLocalRotation(Vec3(0.f, 1.57f, 1.57f));
			gameObject->GetTransform()->SetLocalScale(Vec3(1.f, 1.f, 1.f));
...

	{
		...
		for (auto& gameObject : gameObjects)
		{
			gameObject->SetName(L"EscapeZone2");
			gameObject->SetCheckFrustum(false);
			gameObject->GetTransform()->SetLocalPosition(Vec3(0.f, -4000.f, 0.f));
			//gameObject->GetTransform()->SetLocalRotation(Vec3(0.f, 1.57f, 1.57f));
			gameObject->GetTransform()->SetLocalScale(Vec3(1.f, 1.f, 1.f));
...

	{
		...
		for (auto& gameObject : gameObjects)
		{
			gameObject->SetName(L"EscapeZone3");
			gameObject->SetCheckFrustum(false);
			gameObject->GetTransform()->SetLocalPosition(Vec3(0.f, -4000.f, 0.f));
			//gameObject->GetTransform()->SetLocalRotation(Vec3(0.f, 1.57f, 1.57f));
			gameObject->GetTransform()->SetLocalScale(Vec3(1.f, 1.f, 1.f));
...
#pragma region SpecialEscapeZone
	{
		shared_ptr<MeshData> meshData = GET_SINGLE(Resources)->LoadFBX(L"..\\Resources\\FBX\\SpecialEscapeZone.fbx");

		vector<shared_ptr<GameObject>> gameObjects = meshData->Instantiate();

		for (auto& gameObject : gameObjects)
		{
			gameObject->SetName(L"SpecialEscapeZone");
			gameObject->SetCheckFrustum(false);
			gameObject->GetTransform()->SetLocalPosition(Vec3(0.f, -4000.f, 0.f));
			//gameObject->GetTransform()->SetLocalRotation(Vec3(0.f, 1.57f, 1.57f));
			gameObject->GetTransform()->SetLocalScale(Vec3(1.f, 1.f, 1.f));
...
#pragma region ParticleSystem_Attack
	{
		...
		particle->GetParticleSystem()->MakeParticle(L"ptc1", L"..\\Resources\\Texture\\Particle\\bubble.png", 1);
		particle->SetCheckFrustum(false);
		particle->AddComponent(make_shared<PlayerParticle>());
		//particle->GetParticleSystem()->UseParticle(true);
		particle->GetParticleSystem()->SetParticleOption(1.0f, 1.0f, 300.f, 300.f);
...
#pragma region ParticleSystem_GetItem
	{
		...
		particle->AddComponent(make_shared<Transform>());
		particle->AddComponent(make_shared<ParticleSystem>());
		particle->GetParticleSystem()->MakeParticle(L"ptc2", L"..\\Resources\\Texture\\Particle\\bubble.png", 2);
		particle->SetCheckFrustum(false);
		particle->AddComponent(make_shared<PlayerParticle>());
		//particle->GetParticleSystem()->UseParticle(true);
...
#pragma region ParticleSystem_Gun
	{
		...
		particle->AddComponent(make_shared<Transform>());
		particle->AddComponent(make_shared<ParticleSystem>());
		particle->GetParticleSystem()->MakeParticle(L"ptc3", L"..\\Resources\\Texture\\Particle\\gun.png", 3);
		particle->SetCheckFrustum(false);
		particle->AddComponent(make_shared<PlayerParticle>());
		//particle->GetParticleSystem()->UseParticle(true);
...
#pragma region ParticleSystem_Trap
	{
		...
		particle->AddComponent(make_shared<Transform>());
		particle->AddComponent(make_shared<ParticleSystem>());
		particle->GetParticleSystem()->MakeParticle(L"ptc4", L"..\\Resources\\Texture\\Particle\\blood.png", 4);
		particle->SetCheckFrustum(false);
		particle->AddComponent(make_shared<PlayerParticle>());
		//particle->GetParticleSystem()->UseParticle(true);
