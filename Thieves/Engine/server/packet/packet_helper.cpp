...
#include "Engine/server/packet/packet_helper.h"
#include "Engine/server/packet/packet_event_manager.h"
//#include "server/event/event_system.h"
	...
	/*void PacketHelper::RegisterPacketEventToActor(shared_ptr<MessageEventInfo>&& message, UINT id)
	{
