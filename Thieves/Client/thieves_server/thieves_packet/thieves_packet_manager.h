...
//	char GetDirection() { return direction; };
	...
	Vec3 GetVec() { return _recv_pos; };

	void SetVecX(float p_posx) { _recv_pos.x = p_posx; };
	void SetVecY(float p_posy) { _recv_pos.y = p_posy; };
	void SetVecZ(float p_posz) { _recv_pos.z = p_posz; };
