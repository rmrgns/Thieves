...
{
public:
	static void RegisterMessageEvent(shared_ptr<MessageEventInfo>&& message);
	static void RegisterMessageReceiver(UINT event_id, const shared_ptr<Actor>& actor);
	static void UnregisterMessageReceiver(UINT event_id, const shared_ptr<Actor>& actor);
};
